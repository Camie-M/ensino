...
// admin (permite realizar todas as chamadas na API, para criação de posts e usuários)
// aluno (só pode visualizar os post)
// professor (tem permissão em todas as rotas de POSTS mas não pode criar alunos) 
